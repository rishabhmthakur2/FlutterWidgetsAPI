  ...
  Widget build(BuildContext context) {
    ...
    MaterialCardData FlipObj1 = new MaterialCardData(
      ...
      containerDecoration: BoxDecoration(
        boxShadow: [
          BoxShadow(color: Colors.white, blurRadius: 10, offset: Offset.zero),
        ],
        borderRadius: BorderRadius.circular(20),
        color: Colors.grey,
      ),
      ...
      imgType: "Network",
      imgPath:
          'https://www.freewalldownload.com/lionel-messi/beautiful-lionel-messi-hd-free-football-soccer-player-background-mobile-desktop-download-photos.jpg',
    );
