...
class Page5 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(home: BoilerPlate());
  }
}
...
class _BoilerPlate extends State<BoilerPlate> {
  ...
  Widget build(BuildContext context) {
    ...
    BottomNavigationBarItem bottomnavitem1 = new BottomNavigationBarItem(
      icon: Image.network(
        'http://104.40.75.137:9003/assets/cms/bottomnav_home.png',
        height: 20,
        width: 20,
      ),
    ...
    BottomNavigationBarItem bottomnavitem2 = new BottomNavigationBarItem(
      icon: Image.network(
        'http://104.40.75.137:9003/assets/cms/bottomnav_bookmark.png',
        height: 20,
        width: 20,
      ),
    ...
    BottomNavigationBarItem bottomnavitem4 = new BottomNavigationBarItem(
      icon: Image.network(
        'http://104.40.75.137:9003/assets/cms/bottomnav_profile.png',
        height: 20,
        width: 20,
      ),
      title: Text(
                      ...
                      children: [
                        Row(
                          children: <Widget>[
                            ...
                            CustomTextField(
                                params: finalTextObj0,
                                callbackTextfield: onTextSubmit0),
                          ],
                        ),
                        Padding(
