...
const fs = require('fs');
const batMobile = require.resolve('../flutter-batch-mobile-page1.bat');
...
let getStartedTemplate = (req) => new Promise(async (resolve, reject) => {
  ...
  try {
    ...
    try {
      dataMap.then(() => {
        let data6 = "\nSizedBox(height:0),Expanded(flex: 1,child:" + top + "),"; //Widget1 call
        let data7 = "\n],),\n),\nPadding(\npadding: const EdgeInsets.all(20.0),\nchild: Row(mainAxisAlignment: MainAxisAlignment.center,children: [";
        let data8 = "\nSizedBox(height:20),Expanded(flex: 1,child:" + middle + "),"; //Widget3 call
        let data9 = "\n],),\n),\nPadding(\npadding: const EdgeInsets.all(20.0),\nchild: Row(mainAxisAlignment: MainAxisAlignment.center,children: [";
        let data10 = "\nSizedBox(height:0),Expanded(flex: 1,child:" + middle1 + "),";
        let data11 = "\n],),\n),\nPadding(\npadding: const EdgeInsets.all(25.0),\nchild: Row(mainAxisAlignment: MainAxisAlignment.center,children: [";
        let data12 = "\nSizedBox(height:0),Expanded(flex: 1,child:" + middle2 + "),";
        let data13 = "\n],),\n),\nPadding(\npadding: const EdgeInsets.all(25.0),\nchild: Row(mainAxisAlignment: MainAxisAlignment.center,children: [";
        let data14 = "\nSizedBox(height:60),Expanded(flex: 1,child:" + bottom + "),"; //Widget6 call
        let data15 = "\n ],),\n),\n], \n)  \n))))); \n} \n}";
        let clearFile = () =>
